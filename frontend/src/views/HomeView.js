...
<Card title="Today's Learning Goals" icon={Target} collapsible>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="text-sm font-medium text-amber-600 dark:text-amber-400">{overallProgress}% completed</div>
        </div>
              ...
              <div className="ml-3 flex-1">
                <div className="flex justify-between">
                  ...
                  <span className={`text-xs font-medium ${
                    isHovered ? 'text-amber-600 dark:text-amber-400 scale-110' : 'text-amber-500 dark:text-amber-500'
                  } transition-all`}>
                    +{goal.points} pts
                  </span>
                </div>
      ...
      <div className="mt-5">
        <div className="p-4 rounded-xl">
          ...
          <div className="mt-4">
            <button className="w-full py-2 text-sm bg-amber-500 hover:bg-amber-600 text-white rounded-lg transition-all duration-200 flex items-center justify-center group">
...
const LearningAnalytics = () => {
  ...
  return (
    <Card title="Learning Insights" icon={BarChart2} collapsible>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        {insights.map((insight, index) => {
          ...
          return (
            <div 
              key={index} 
              className="bg-white dark:bg-gray-750 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 hover:border-amber-200 dark:hover:border-amber-800 hover:shadow-md transition-all duration-200 group"
            >
      ...
      <div className="mt-6">
        <div className="p-4 bg-white dark:bg-gray-750 rounded-xl border border-gray-100 dark:border-gray-700 hover:border-amber-200 dark:hover:border-amber-800 transition-all duration-200">
          <div className="flex items-center mb-3">
    ...
    >
      <div className="flex items-center gap-4">
        <div className="flex-1">
          ...
          <div className="text-sm bg-gradient-to-r from-amber-500 to-amber-600 bg-clip-text text-transparent dark:from-amber-400 dark:to-amber-300 mt-1">
          ...
          <div className="mt-3 flex justify-between items-center">
            ...
            <button className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 flex items-center ${
              isHovered ? 'bg-amber-500 text-white shadow-md' : 'bg-amber-100 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400'
            }`}>
              Continue
...
const HomeView = () => {
    ...
    <div className="w-full max-w-full lg:max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex justify-between items-start bg-white dark:bg-gray-900 p-2">
        <div>
          ...
          <p className="mt-1 text-base font-medium bg-gradient-to-r from-red-500 to-amber-600 bg-clip-text text-transparent dark:from-amber-400 dark:via-amber-300 dark:to-amber-500">
  ...
  <BookOpen size={20} className="mr-2 text-amber-500 dark:text-amber-400" />
  Continue Learning
</h2>

      <button 
        onClick={() => navigate('/courses')}
        className="text-sm px-3 py-1.5 rounded-lg text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 hover:shadow-sm transition-all duration-200 flex items-center group"
      >
        View All
        <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-0.5 transition-transform" />
      </button>
